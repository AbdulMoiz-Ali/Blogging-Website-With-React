...
function Herocard({ image, title, description, link }) {
    return (
        <>
            <div className="w-96 m-3 items-center sm:flex-col bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                ...
                <article className="p-6 bg-white rounded-b-lg border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p className="mb-5 font-light text-gray-500 dark:text-gray-400">{description.slice(0, 130) + "....."}</p>
